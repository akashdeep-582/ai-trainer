// AutoDataCollector with Mediapipe BlazePose (x, y, z, score) + New Exercises
  ...
  return (
    <Stack spacing={3} alignItems="center" sx={{ p: 3 }}>
      ...
      <Stack direction="row" spacing={2}>
        <Button
          variant={exercise === "left_bicep" ? "contained" : "outlined"}
          color="primary"
          onClick={() => updateExercise("left_bicep")}
        >
          Left Bicep
        </Button>
        <Button
          variant={exercise === "right_bicep" ? "contained" : "outlined"}
          color="primary"
          onClick={() => updateExercise("right_bicep")}
        >
          Right Bicep
        </Button>
        <Button
          variant={exercise === "left_shoulder" ? "contained" : "outlined"}
          color="primary"
          onClick={() => updateExercise("left_shoulder")}
        >
          Left Shoulder
        </Button>
        <Button
          variant={exercise === "right_shoulder" ? "contained" : "outlined"}
          color="primary"
          onClick={() => updateExercise("right_shoulder")}
        >
          Right Shoulder
        </Button>
        <Button
          variant={exercise === "rest" ? "contained" : "outlined"}
          color="primary"
          onClick={() => updateExercise("rest")}
        >
          Rest
        </Button>
      </Stack>
